...
nameInputElement.addEventListener("keydown", addNewContactOnPressingEnterKey1);
...
function addNewContactOnPressingEnterKey1(e) {
  if (e.key === "Enter") {
    addNewContact();
  }
}
...
function handleTableActions(e) {
  if (e.target.classList.contains("fa-trash") === true) {
    ...
    tableRowToBeEdited.style.backgroundColor = "#BC7FCD";
